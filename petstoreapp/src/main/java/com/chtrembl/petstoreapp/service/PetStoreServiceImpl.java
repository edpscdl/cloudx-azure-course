...
public class PetStoreServiceImpl implements PetStoreService {
	...
	public void initialize() {
		...
		this.orderServiceWebClient = WebClient.builder().baseUrl(this.containerEnvironment.getPetStoreOrderServiceURL())
				.build();
		this.orderItemsReserverWebClient = WebClient.builder().baseUrl(this.containerEnvironment.getPetStoreOrderItemsReserverServiceURL())
				.build();
	}
	...
	public void updateOrder(long productId, int quantity, boolean completeOrder) {
		...
		try {
			...
			if (updatedOrder != null) {
				this.sessionUser.getTelemetryClient()
						.trackEvent(
								String.format("The order was updated for user %s, session ID %s",
				...
				try {
					...
					String reserv = this.orderItemsReserverWebClient.post()
							.uri("orderstorage/{sessionId}", this.sessionUser.getSessionId())
